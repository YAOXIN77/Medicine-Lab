...
class RandomAirwayErrorGenerator(object):
    ...
    Args:
        ...
        is_error_type2 (bool): option to enable errors type2: blanking some small random branches
    ...
    def _calc_indexes_candidate_branches_error_type1(self, ipatient):
        ...
        if self._is_exclude_small_branches_error_t1:
            ...
            for ibrh in range(num_branches):
                begin_point_branch = (begpoint_x_branches[ibrh], begpoint_y_branches[ibrh], begpoint_z_br anches[ibrh])
